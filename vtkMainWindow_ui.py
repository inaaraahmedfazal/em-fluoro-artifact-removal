...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fluoroImgLabel = QtWidgets.QLabel(self.imageWidget)
        self.fluoroImgLabel.setText("")
        self.fluoroImgLabel.setObjectName("fluoroImgLabel")
        self.videoGridLayout.addWidget(self.fluoroImgLabel, 0, 0, 1, 1)
        self.centralLayout.addWidget(self.imageWidget, 0, 0, 1, 2)
        ...
        self.centralLayout.addWidget(self.vtkWidget, 1, 0, 1, 2)
        ...
        self.ToolTyLCD = QtWidgets.QLCDNumber(self.frame_3)
        self.ToolTyLCD.setFrameShadow(QtWidgets.QFrame.Plain)
        self.ToolTyLCD.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
        self.ToolTyLCD.setObjectName("ToolTyLCD")
        self.gridLayout_4.addWidget(self.ToolTyLCD, 2, 1, 1, 1)
        self.ToolTzLCD = QtWidgets.QLCDNumber(self.frame_3)
        self.ToolTzLCD.setFrameShadow(QtWidgets.QFrame.Plain)
        self.ToolTzLCD.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
        self.ToolTzLCD.setObjectName("ToolTzLCD")
        self.gridLayout_4.addWidget(self.ToolTzLCD, 3, 1, 1, 1)
        self.ToolTxLCD = QtWidgets.QLCDNumber(self.frame_3)
        self.ToolTxLCD.setFrameShadow(QtWidgets.QFrame.Plain)
        self.ToolTxLCD.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
        self.ToolTxLCD.setObjectName("ToolTxLCD")
        self.gridLayout_4.addWidget(self.ToolTxLCD, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.frame_3, 18, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "Tracker Pose"))

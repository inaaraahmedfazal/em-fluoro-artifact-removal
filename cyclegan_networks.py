...
class UnetGenerator(nn.Module):
    ...
    def consistency_loss(self, gen_img):
        """
        Calculate consistency loss for the generator.
        ...
        """
        # Run the generated image through the generator again
        gen_gen_img = self.forward(gen_img.detach())

        # Calculate the consistency loss (MSE in this case)
        consistency_loss = nn.MSELoss()(gen_gen_img, gen_img.detach())
